...
//    else if((B.x-A.x)*(D.y-C.y)==(D.x-C.x)*(B.y-A.y))    puts("NONE");  //平行
            ...
            double tmp = Point2Line(l1.a,l2.a,l2.b);
//            double a1,b1,c1,a2,b2,c2;
//            LineEquation(l1.a,l1.b,a1,b1,c1);
//            LineEquation(l2.a,l2.b,a2,b2,c2);
//            if ( dcmp(tmp) == 0 && dcmp(l1.angle-l2.angle ) == 0 ){
            if ( fabs(cross(l1.a,l1.b,l2.a))<=eps&&fabs(cross(l1.a,l1.b,l2.b))<=eps ) {
                puts("LINE");
//            }else if ( dcmp(l1.angle-l2.angle ) == 0 ){
            }else if((l1.b.x-l1.a.x)*(l2.b.y-l2.a.y)==(l2.b.x-l2.a.x)*(l1.b.y-l1.a.y)) {
                puts("NONE");
            }else {
                point_t o = lineCrossline(l1,l2);
                printf("POINT %.2f %.2f\n",o.x,o.y);
            }
